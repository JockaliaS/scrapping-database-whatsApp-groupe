      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          <div className="mb-10 text-center">
            <h2 className="text-4xl font-extrabold tracking-tight text-slate-900 mb-2">Creer un compte</h2>
            <p className="text-lg text-slate-600">Rejoignez Radar et detectez vos opportunites</p>
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <label className="flex flex-col gap-2">
                <span className="mono-label text-xs font-bold text-slate-500">Nom complet</span>
                <input
                  type="text"
